          ...
          <Grid>
            <Row>
              <Col sm={6} className="footer-nav-wrap">
                ...
                <p>This is a fully integrated open-source project that uses Bootstrap 3, <br className="hidden-xs"/>Python and Django to build. Grab your copy from <a href="#!">GitHub</a>.</p>
              </Col>
